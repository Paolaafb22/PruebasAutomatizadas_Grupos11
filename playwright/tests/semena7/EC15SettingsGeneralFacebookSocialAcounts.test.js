...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('https://www.facebook.com/username').fill();
  await page.getByPlaceholder('https://www.facebook.com/username').fill(faker.internet.url);
  await page.screenshot({path: './src/EC15.png'})
