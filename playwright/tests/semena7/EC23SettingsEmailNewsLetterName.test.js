...
await page.getByPlaceholder('Weekly Roundup').click();
await page.getByPlaceholder('Weekly Roundup').fill(faker.lorem.paragraph(400));
await page.getByPlaceholder('Weekly Roundup').press('Tab');
await page.screenshot({path: './src/EC23.png'})
