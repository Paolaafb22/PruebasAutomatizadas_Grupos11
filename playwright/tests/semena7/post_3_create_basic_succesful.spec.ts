...
test('create_post_basic_success', async ({ page }) => {
  ...
  await page.screenshot({path: '../../result/post_1_create_succesful/2-post_screen_before_save__webkit.png'})
  await page.waitForTimeout(10000);
  await page.getByText('Draft - Saved').click();
  await page.goto(`${_baseUrlGhost}#/dashboard`);
  await page.screenshot({path: '../../result/post_1_create_succesful/3-post_screen_after_save__webkit.png'})
});