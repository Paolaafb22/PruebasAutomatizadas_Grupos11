describe("E019-CreateTag", () => {
  ...
  it("Input Meta description one-character", () => {
    ...
    cy.get('textarea[id="meta-description"]').type(randomRow['tag-meta-desc']);
    cy.wait(1000);
    cy.screenshot();
