describe("E023-CreateTag", () => {
  ...
  it("Input Meta Canonical URL invalid-data", () => {
    ...
    cy.get('input[id="canonical-url"]').type(randomRow['tag-url']);
    cy.wait(1000);
    cy.screenshot();
