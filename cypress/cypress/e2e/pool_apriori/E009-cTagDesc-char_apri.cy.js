describe("E009-CreateTag", () => {
  ...
  it("Input Description one-character", () => {
    ...
    cy.get('textarea[id="tag-description"]').type(randomRow['tag-description']);
